...
from apartados.Ejercicio1apartado3 import mostrarEstadisticas
def ejercicio1():    
    while True:
        os.system("cls")
        print("1-Generar una lista aleatoria con datos del género de 100 personas")
        ...
        if int(opcion) == 1:
            contenido = str(["H" if randint(0,1) == 1 else "M" for _ in range(1,101)])
            ...
            print("Ha cerrado el ejercicio 1, hasta la próxima")
            time.sleep(3)
            break      
        else:
